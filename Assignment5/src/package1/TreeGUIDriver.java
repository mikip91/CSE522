	...
	public TreeGUI() {
		...
		minButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				if (tm.get_state() != null) {
					...
					JOptionPane.showMessageDialog(null, "Tree is empty. No minimum value!");
			}
		});
		...
		maxButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				if (tm.get_state() != null) {
					...
					JOptionPane.showMessageDialog(null, "Tree is empty. No maximum value!");
			}
		});
		...
		clearButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				if (tm.get_state() != null) {
					...
					input_elem_text2.setText(""); // set delete input text to blank
					tm.clear();
					min_text.setText("");
					max_text.setText("");
				...
				if (is_new_tree) {
					...
					try {
						if (tree == null) {
							...
							insertSuccess = tree.insert(Integer.parseInt(s));
							if (insertSuccess || tree_kind.getSelectedIndex() == 1)
								tm.set_state(tree);
							else {
								JOptionPane.showMessageDialog(null, "Cannot insert duplicate node on Normal Tree");
								return;
							}
						}
					} catch (NumberFormatException e2) {
		...
		deleteButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (tree.left == null && tree.right == null && tree.value == n && tree.get_count() == 1) {
					tm.set_state(tree);
					tree = null;
					outputPanel.clearPanel();
					JOptionPane.showMessageDialog(null, "Deleted Root Node");
					return;
				}
				...
				if (b) {
					tm.set_state(tree);
					outputPanel.drawTree(tree);
				} else if (b == false && n == tree.value) {
					is_new_tree = false;
					tree = null;
					outputPanel.clearPanel();
					tm.set_state(tree);
				} else
					JOptionPane.showMessageDialog(null, "Unable to delete. Not in tree  " + n);
		...
		undoButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				AbsTree temptree1 = tm.get_state();
				tree = tm.get_state();
